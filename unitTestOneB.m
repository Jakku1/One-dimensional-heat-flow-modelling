...
tol = 1e-14;
lmda = 2; %diffusion coefficient
eID=1; %element ID
msh = OneDimLinearMeshGen(0,1,10);

elemat = LaplaceReacElementMatrix(lmda,eID,msh); %THIS IS THE FUNCTION YOU MUST WRITE
...
tol = 1e-14;
lmda = 5; %diffusion coefficient
eID=1; %element ID
msh = OneDimLinearMeshGen(0,1,10);

elemat1 = LaplaceReacElementMatrix(lmda,eID,msh);%THIS IS THE FUNCTION YOU MUST WRITE

eID=2; %element ID

elemat2 = LaplaceReacElementMatrix(lmda,eID,msh);%THIS IS THE FUNCTION YOU MUST WRITE
